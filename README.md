...
Tis project repreents a modular stereo-vision system that detects multiple objects using a **stereo camera setup** and estimates their **3D position in real time**, even during **temporary occlusions**.  
